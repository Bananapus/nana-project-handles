...
contract DeployGoerli is Test {
    IJBPermissions permissions = IJBPermissions(0x99dB6b517683237dE9C494bbd17861f3608F3585);
...
contract DeployMainnet is Test {
    IJBPermissions permissions = IJBPermissions(0x6F3C5afCa0c9eDf3926eF2dDF17c8ae6391afEfb);
